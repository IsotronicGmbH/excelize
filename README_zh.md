...
<p align="center">
    ...
    <a href="https://goreportcard.com/report/github.com/IsotronicGmbH/excelize"><img src="https://goreportcard.com/badge/github.com/IsotronicGmbH/excelize" alt="Go Report Card"></a>
    <a href="https://pkg.go.dev/github.com/IsotronicGmbH/excelize/v2?tab=doc"><img src="https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white" alt="go.dev"></a>
...
```bash
go get github.com/IsotronicGmbH/excelize
```

- 如果您使用 [Go Modules](https://blog.golang.org/using-go-modules) 管理软件包，请使用下面的命令来安装最新版本。

```bash
go get github.com/IsotronicGmbH/excelize/v2
```
...
import (
    ...
    "github.com/IsotronicGmbH/excelize/v2"
)
